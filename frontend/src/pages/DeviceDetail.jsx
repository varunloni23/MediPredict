    ...
    <div>
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-gray-900">Explainable AI Insights</h2>
          <button
        ...
        {explanation ? (
          <div className="space-y-6">
            ...
            <div className="border-l-4 border-blue-500 pl-4 py-2 bg-blue-50">
              <h3 className="font-semibold text-gray-900 mb-2">Prediction Summary</h3>
              <div className="flex items-center gap-4 mb-2">
                <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getStatusClass(explanation.prediction)}`}>
                  {getStatusText(explanation.prediction)}
                </span>
                <span className="text-sm text-gray-600">
                  Confidence: <strong>{(explanation.confidence * 100).toFixed(1)}%</strong>
                </span>
              </div>
              <p className="text-sm text-gray-700 whitespace-pre-line">{explanation.explanation}</p>
            </div>

            {/* Class Probabilities */}
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">Prediction Probabilities</h3>
              <div className="space-y-2">
                {Object.entries(explanation.class_probabilities).map(([className, probability]) => (
                  <div key={className}>
            ...
            <div className="border-l-4 border-green-500 pl-4 py-2 bg-green-50">
              <h3 className="font-semibold text-gray-900 mb-2">AI-Generated Recommendations</h3>
              <p className="text-sm text-gray-700 whitespace-pre-line">{explanation.recommendation}</p>
            </div>

            {/* Timestamp */}
            <div className="text-xs text-gray-500 text-right">
              Analysis generated at: {new Date(explanation.timestamp).toLocaleString()}
            </div>
          </div>
        ) : (
          <div className="text-center py-8">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Click "Generate AI Explanation" to see detailed insights about this device's health prediction
            </p>
          </div>
        )}
      </div>
